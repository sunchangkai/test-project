...
Vue.use(d2CrudPlus, {
  ...
  getRemoteDictFunc(url, dict) {
    ...
    return request({
      ...
      if (dict.isTree) {
        return XEUtils.toArrayTree(ret.data.data || ret.data, {
          parentKey: 'parent',
          strict: false,
        });
      } else {
    ...
    return {
      toolBar: {
        text: {
          ...
          searchBtn: 'Show/Hide Queries',
          compactBtn: 'Compact Pages',
          exportBtn: 'Export Data',
          columnsSetBtn: 'Column Settings',
          columnsSet: {
      ...
      form: {
        ...
        helper: {
          render(h) {
            return (
              <el-alert
                title="If not filled, it is the department ID of the currently created user"
                type="info"
              />
            );
          },
