...
export const getMenu = function() {
  return request({
    ...
    // 设置动态路由
    // console.log('steven menu data',JSON.stringify(res.data.data))
    // console.log('steven menu data',JSON.stringify(res.data.data.name))
    // for (const item of res.data.data) {
    // console.log('steven menu name',item.name)
    // }
...
export const handleAsideMenu = function(menuData) {
  ...
  const menu = [{ path: '/index', title: 'Workbench', icon: 'home' }, ...data];
