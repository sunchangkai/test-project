      ...
      >
          ...
          <div v-else-if="['img', 'imgs'].indexOf(item.form_item_type_label) > -1" :key="index">
            ...
            >
              ...
              <div slot="tip" class="el-upload__tip">
                After selecting the picture, it needs to be manually uploaded to the server, and
              ...
              <vxe-column title="operation" width="100" show-overflow>
                <template #default="{ row,index }">
                  <el-popover placement="top" width="160" v-model="childRemoveVisible">
                    <p>It cannot be recovered after deletion, are you sure to delete?</p>
                    <div style="text-align: right; margin: 0">
                      <el-button size="mini" type="text" @click="childRemoveVisible = false"
                        >cancel</el-button
                      >
                      <el-button
                        type="primary"
                        size="mini"
                        @click="onRemoveChild(row, index, item.key)"
                        >OK</el-button
                      >
                    </div>
        ...
        <el-col :span="4" :offset="1">
          <el-input
            ...
            style="width: 200px;"
            placeholder="Please enter the variable key"
          >
